...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        fileListWidget->setGeometry(QRect(15, 71, 351, 371));
        QFont font1;
        font1.setPointSize(8);
        fileListWidget->setFont(font1);
        selectFileButton = new QPushButton(centralwidget);
        selectFileButton->setObjectName(QString::fromUtf8("selectFileButton"));
        selectFileButton->setGeometry(QRect(21, 510, 171, 31));
        QFont font2;
        ...
        convertButton->setGeometry(QRect(201, 510, 171, 31));
        convertButton->setFont(font2);
        saveButton = new QPushButton(centralwidget);
        saveButton->setObjectName(QString::fromUtf8("saveButton"));
        saveButton->setGeometry(QRect(410, 510, 171, 31));
        ...
        outputTextEdit->setGeometry(QRect(370, 70, 411, 371));
        ...
        fileCountLabel->setGeometry(QRect(30, 30, 131, 21));
        fileCountLabel->setFont(font);
        clearButton = new QPushButton(centralwidget);
        clearButton->setObjectName(QString::fromUtf8("clearButton"));
        clearButton->setGeometry(QRect(590, 510, 171, 31));
        clearButton->setFont(font2);
        progressBar = new QProgressBar(centralwidget);
        progressBar->setObjectName(QString::fromUtf8("progressBar"));
        progressBar->setGeometry(QRect(60, 460, 661, 23));
