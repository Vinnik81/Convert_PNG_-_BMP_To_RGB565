    ...
    for (const QString &filename : fileList)
        {
           ...
           /* if (!widthOk || !heightOk || width <= 0 || height <= 0)
            ...
            if (!data.empty())
            {
                ...
                QString saveFileName = outputDirectory + "/" + baseFileName + ".c";
                ...
                if (!saveFileName.isEmpty())
                {
                    ...
                    out << "#include <main.h>\n\n";
                    //out << "static const uint16_t " << baseFileName << "_" << extension << "_image_data[] = {\n";
                    out << "static const uint16_t " << "data[] = {\n";
                    ...
                    out << "#include \"image.h\"\n";
                    out << "const " << "image_TypeDef " << baseFileName << " = {" << width << ", " << height << ", " << "data};";
                    file.close();
                }
            }
            currentFileIndex++;
